...
class Options(usage.Options):
    optParameters = [
        ...
        ['sshKeyDir', None, None, "Directory where autogenerated SSH key is kept"],
        ['sshKeyName', None, 'server.key', "Filename of autogenerated SSH key"],
        ['sshKeySize', None, 4096, "Size of automatically generated SSH key"],
        ['metricsPort', None, 9111, "Port number for Prometheus metrics"],
    ]

    optFlags = [
        ['skipSchemaCheck', 'x', "Don't check schema integrity"],
        ['migrate', 'm', "Run db migrations"],
    ]
